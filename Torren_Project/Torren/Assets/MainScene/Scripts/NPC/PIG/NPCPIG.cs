...
public class NPCPIG : MonoBehaviour {
	...
	bool MarkerOn = false;
	private NPCPIGManager PIGManager;
	...
	void Start () {
		...
		PIGManager = GameObject.FindGameObjectWithTag ("NPCPigManager").GetComponent<NPCPIGManager> ();
